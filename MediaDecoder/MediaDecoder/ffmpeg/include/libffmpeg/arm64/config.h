...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-pthreads --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-videotoolbox --disable-encoders --enable-encoder=aac --enable-encoder=wavpack --enable-encoder=pcm_s16le --enable-encoder=libx264 --disable-decoders --enable-decoder=h264 --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder='mp3*' --enable-decoder=wavpack --enable-decoder=pcm_s16le --disable-hwaccels --disable-muxers --enable-muxer=mp4 --enable-demuxer=aac --enable-demuxer=mov --enable-demuxer=mp3 --enable-muxer=wav --disable-demuxers --enable-demuxer=aac --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=wav --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --enable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --enable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --enable-protocols --enable-protocol=async --disable-protocol=bluray --enable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --enable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --disable-devices --enable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --disable-debug --enable-small --prefix=/Users/wangyang/wangyang-git/ijkplayer/ios/build/ffmpeg-arm64/output --enable-libx264 --cc='xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -miphoneos-version-min=7.0 -I/Users/wangyang/wangyang-git/ijkplayer/ios/build/x264-arm64/output/include' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=7.0 -I/Users/wangyang/wangyang-git/ijkplayer/ios/build/x264-arm64/output/include' --extra-ldflags=' -arch arm64 -miphoneos-version-min=7.0 -L/Users/wangyang/wangyang-git/ijkplayer/ios/build/x264-arm64/output/lib -lx264'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Users/wangyang/wangyang-git/ijkplayer/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/wangyang/wangyang-git/ijkplayer/ios/build/ffmpeg-arm64/output/share/ffmpeg"
